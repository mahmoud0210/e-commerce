                ...
                <div class="card mb-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="head" class="form-control @error('head') is-invalid @enderror "
                                id="header" aria-describedby="" placeholder="Email header">
                            @error('head')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="body" class="form-control @error('body') is-invalid @enderror "
                                id="body" aria-describedby="" placeholder="Email body">
                            @error('body')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" name="urlaction"
                                class="form-control @error('urlaction') is-invalid @enderror " id="url"
